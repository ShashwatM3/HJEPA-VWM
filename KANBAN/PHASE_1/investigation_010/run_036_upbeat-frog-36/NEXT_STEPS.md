# Next Steps - run 036 `upbeat-frog-36`
...
- Next chronological W&B run: Run 037 [`soft-universe-37`](../run_037_soft-universe-37/)
...
**Connection:** aborted early; carries no result. Directly relaunched as run 037
(`soft-universe-37`), which is the same config run to completion. Use 037, not this, for any
conclusion about the residual recipe.
