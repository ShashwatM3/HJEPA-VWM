...
2. Launch the six core arms from one clean commit and record each W&B ID in `DESCRIPTION.md`.
...
4. After all runs finish, apply Reading Cycle B separately, then compare the two within-dataset
   `32 -> 64 -> 128` curves using [`PLAN.md`](PLAN.md).
