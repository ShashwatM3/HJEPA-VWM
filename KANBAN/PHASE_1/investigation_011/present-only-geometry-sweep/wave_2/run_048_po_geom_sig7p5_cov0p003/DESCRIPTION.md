# Run 048 - `po_geom_sig7p5_cov0p003`

**Current W&B run name:** `Investigation 11 · Present geometry · Isotropy 7.5, covariance 0.003`

<!-- AUTO-GENERATED-WANDB-KANBAN -->

**Investigation:** [investigation_011](../../../)  
**W&B:** `bg7ennr5` - https://wandb.ai/smahalanobis-uc-davis/hjepa-vwm/runs/bg7ennr5  
**State:** `crashed`  
**Created:** 2026-07-02T03:48:46Z  
**Last history step:** 14000  
...
Present-only geometry sweep wave 2 member: sigreg=7.5, cov=0.003.
...
| `agc_enabled` | true |
| `checkpoint_dir` | /workspace/ckpt/inv011_present_only_geometry_sweep/po_geom_sig7p5_cov0p003 |
...
| `lambda_sigreg` | 5 | 7.5 |
| `checkpoint_dir` | /workspace/ckpt/inv011_present_only_geometry_sweep/po_geom_sig5_cov0p01 | /workspace/ckpt/inv011_present_only_geometry_sweep/po_geom_sig7p5_cov0p003 |

## Chronological Linkage

- Previous W&B run: Run 047 [`po_geom_sig5_cov0p01`](../run_047_po_geom_sig5_cov0p01/).
- Next W&B run: Run 049 [`po_geom_sig10_cov0p01`](../run_049_po_geom_sig10_cov0p01/).
