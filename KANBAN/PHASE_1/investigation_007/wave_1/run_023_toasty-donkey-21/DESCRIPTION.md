...
Decoder/reconstruction capacity wave member; tests another capacity/weight point.
...
| `agc_enabled` | true |
| `checkpoint_dir` | /workspace/ckpt/L0.1_D256x2_nc32 |

## Difference From Previous W&B Run

| Config key | Previous run | This run |
|---|---:|---:|
| `lambda_recon` | 0.05 | 0.1 |
| `decoder_dim` | 512 | 256 |
| `checkpoint_dir` | /workspace/ckpt/L0.05_D512x2_nc32 | /workspace/ckpt/L0.1_D256x2_nc32 |

## Chronological Linkage

- Previous W&B run: Run 022 [`gallant-dew-22`](../run_022_gallant-dew-22/).
- Next W&B run: Run 024 [`light-universe-24`](../run_024_light-universe-24/).
...
|---|---|
| W&B run files | `artifact/3052402069/wandb_manifest.json` (0 bytes), `requirements.txt` (3820 bytes), `wandb-metadata.json` (2389 bytes) |
| Logged artifacts | `run-a2trqp9c-history:v0` (wandb-history) |
...
**Prev:** baseline [`easy-blaze-19`](../../../investigation_006/run_019_easy-blaze-19/) (λ=0.05) · **Next:** [jolly-glade-20](../run_020_jolly-glade-20/) (λ=0.2)
**W&B:** `a2trqp9c` · https://wandb.ai/smahalanobis-uc-davis/hjepa-vwm/runs/a2trqp9c
